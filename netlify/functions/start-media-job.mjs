...
export default async req=>{
  ...
  const job_id=uid('JOB'),jobs=await store(STORES.jobs),job={job_id,asset_id,kind,status:'QUEUED',progress:0,created_at:new Date().toISOString(),source_variant_id:cleanId(b?.source_variant_id)||null,recipe:b?.recipe||{},reason};
